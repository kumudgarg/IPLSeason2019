...
public class IPLTestWithMockito {
    ...
    public void setUp() throws Exception {
        ...
        this.recordDAOMap.put("shivam", new IPLRecordDAO("shivam",1500,23.36,36.15,140,100,200));
        this.recordDAOMap.put("Rohit", new IPLRecordDAO("Rohit", 1500,66.14,36.15,140,100,202));
        this.recordDAOMap.put("kapil", new IPLRecordDAO("kapil",900,56.12,29.98,95,66,190));
